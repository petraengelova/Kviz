...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Pokračovat',
                nextQuestionText: 'Další',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: 'Zkus to znovu',
                questionCountText: '',
                preventUnansweredText: 'Musíš zaškrtnout alespoň jednu možnost.',
                questionTemplateText:  '%count. %text',
                scoreTemplateText: '%score / %total',
                nameTemplateText:  '<span>Kvíz: </span>%name',
